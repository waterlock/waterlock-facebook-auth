 ...
 * @param {object} config the object contains the waterlock-facebook-auth config in config/waterlock.js
...
function FBOAuth2(config){
  ...
  this._profileURI = config.profileQuery;
}
